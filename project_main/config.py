...
# --- Servo ---
SERVO_PIN = 18                     # ขา GPIO ที่ต่อกับสาย Signal ของ Servo (Pin 12)
...
SERVO_DELAY = 1.0                  # เวลาหน่วง (วินาที) ก่อนเปลี่ยนมุมถัดไป
SERVO_SETTLE_TIME = 0.5            # เวลาหน่วง (วินาที) รอให้ Servo เสถียรหลังตั้งมุมใหม่
SERVO_STEP_DELAY = 0.03            # เวลาหน่วงระหว่างขยับทีละองศา (ยิ่งมากยิ่งช้า/Slowlife)
...
# --- Face Detection ---
FACE_MODEL = 0                     # โมเดลตรวจจับใบหน้า (0 = ระยะใกล้ 2m, 1 = ระยะไกล 5m)
