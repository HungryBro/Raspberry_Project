...
SERVO_ANGLES = [90, -90]         # ลำดับมุมที่ Servo จะหมุนไป วนลูป (ลดจาก 90/-90 เพื่อไม่ให้ชนขอบ)
SERVO_DELAY = 1.5                  # เวลาหน่วง (วินาที) ก่อนเปลี่ยนมุมถัดไป
SERVO_SETTLE_TIME = 1.0            # เวลาหน่วง (วินาที) รอให้ Servo เสถียรหลังตั้งมุมใหม่ (เพิ่มเวลาให้หมุนทัน)
