"""
config.py - ค่าคงที่ทั้งหมดของระบบ Project012
Smart Fan ควบคุมด้วย Sign Language (Local YOLO Model - train เอง)
...
YOLO_MODEL_PATH = "models/best.pt"          # path ไปยัง model ที่ train เอง
YOLO_CONFIDENCE = 0.70                      # ค่าความมั่นใจขั้นต่ำ
YOLO_IMG_SIZE = 640                         # resize ภาพ (ตรงกับขนาดตอน train)
